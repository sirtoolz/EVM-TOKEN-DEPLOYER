...
def setup_dependencies():
    ...
    try:
        print(f"\033[96mInstalling dependencies...\033[0m")  # Cyan
        os.system("pip install web3.py py-solc-x colorama")
        from solcx import install_solc
        install_solc("0.8.0")
        print(f"\033[92mDependencies installed successfully!\033[0m")  # Green
    except Exception as e:
        print(f"\033[91mError installing dependencies: {e}\033[0m")  # Red
        sys.exit(1)
